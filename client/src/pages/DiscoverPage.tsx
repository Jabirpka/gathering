...
import { DiscoverGroup } from '../types';
import { GROUP_CATEGORIES } from '../utils/groups';
import { ArrowLeft, Search, Loader2, Users, Compass } from 'lucide-react';
...
/** Browse & join public groups by category / search (Communities). */
