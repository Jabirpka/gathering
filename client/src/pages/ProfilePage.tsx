  ...
  return (
    <div className="p-6 max-w-lg mx-auto animate-fade-in">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-xs text-slate-400 mt-2">Click photo to change · Max 2MB</p>
      ...
      <div className="card p-5 space-y-4 mb-4">
        ...
        <div>
          ...
          />
          <p className="text-xs text-slate-500 mt-1">Shown instead of your name in chats & pokes</p>
        </div>
      ...
      >
        ...
        <span className="text-sm font-medium text-slate-200 group-hover:text-red-400 transition-colors">
          Sign out
        </span>
      </button>
    </div>
